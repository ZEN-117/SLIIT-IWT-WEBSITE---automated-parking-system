...
if( $result->num_rows > 0){
    ...
    while($row = $result -> fetch_assoc()){
        ...
        echo "<td>";
        echo "<button class='update-btn' onClick=\"redirectToUpdateFormReserve(". $row ["id"] . ")\">Update</button>";
...
?>
<script>
function redirectToUpdateFormReserve(id) {
    window.location.href = "update_reserve.php?id=" + id;
}
</script>
</body>
</html>
